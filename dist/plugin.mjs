import { makeTransformerFactory } from 'typescript-transform-wx-cloud';
import { basename, parse, dirname, join } from 'path';
import { source } from 'common-tags';
import { upperFirst, kebabCase, debounce } from 'lodash';
...
function createTransformerAndPlugin(options) {
    ...
    const outputDirectory = (baseDir, fpath) => {
        ...
        return join(baseDir, cloudName$1(name));
    };
    return { wxCloudTransformer, wxCloudPlugin, outputDirectory };
}

export { createTransformerAndPlugin };
